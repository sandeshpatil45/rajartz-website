...
const SCENE_ASSETS = ['hero-scene', 'particles'];

function App() {
  const { loading, progress } = use3DLoader(SCENE_ASSETS);
  useDeviceDetection();
  useScrollAnimations();
      ...
      {!loading && (
        <div className="relative">
          ...
          <a
            ...
            className="fixed bottom-8 right-8 z-50 glass-gold p-4 rounded-full animate-breathe hover:animate-glow transition-all duration-300"
